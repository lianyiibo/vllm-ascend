...
class AscendAttentionTorchairBackendImpl(AttentionImpl):
    ...
    def forward(
        ...
        if attn_metadata.attn_state == AscendAttentionState.PrefillNoCache:
            ...
            k_cache = self.key_cache.view(self.key_cache.shape[0], self.key_cache.shape[1], self.num_kv_heads, -1)
            v_cache = self.value_cache.view(self.value_cache.shape[0], self.value_cache.shape[1], self.num_kv_heads, -1)
